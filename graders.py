...
# Hard safe boundaries - guaranteed strictly between 0 and 1
# Using 0.001 / 0.999 to avoid any floating point rounding issues
_LO = 0.001
_HI = 0.999
...
def grade_episode(
    ...
    # Apply strict_unit_interval to every dimension score
